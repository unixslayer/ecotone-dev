...
class RuntimeTests extends Crypto
{
     ...
     */
    public static function runtimeTest(): void
    {
        ...
        try {
            ...
            Core::ensureTrue(Core::strlen(Key::createNewRandomKey()->getRawBytes()) === Core::KEY_BYTE_SIZE);
     ...
     */
    private static function testEncryptDecrypt(): void
    {
        ...
        try {
            ...
            throw new EnvironmentIsBrokenException(previous: $ex);
        }
        ...
        try {
            ...
            throw new EnvironmentIsBrokenException();
        } catch (WrongKeyOrModifiedCiphertextException $e) { /* expected */
        }
     ...
     */
    private static function HKDFTestVector(): void
    {
     ...
     */
    private static function HMACTestVector(): void
    {
        ...
        Core::ensureTrue(hash_hmac(Core::HASH_FUNCTION_NAME, $data, $key) === $correct);
    }
     ...
     * @throws EnvironmentIsBrokenException|BadFormatException
     */
    private static function AESTestVector(): void
    {
